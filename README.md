...
<head>
    ...
    <style>
        body {
            ...
            background-color: #F0EDE5; /* Light earthy background */
        }
        .chart-container {
            position: relative;
            margin-left: auto;
        ...
        .icon-box {
            ...
            height: 48px;
            border-radius: 50%;
            background-color: #E67E22; /* Vibrant accent */
            color: #4A3A2D; /* Dark earthy tone */
            font-size: 1.5rem;
            font-weight: bold;
            margin-bottom: 1rem;
        }
...
<body class="text-gray-800">
    ...
    <main class="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <section class="text-center bg-[#4A3A2D] text-white rounded-lg shadow-md p-8">
